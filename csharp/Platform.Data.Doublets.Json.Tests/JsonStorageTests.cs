...
namespace Platform.Data.Doublets.Json.Tests
{
    public static class JsonStorageTests
    {
        ...
        public static void AttachTrueValueToDocumentTest()
        {
            ...
            TLink createdTrueLink = links.GetTarget(createdTrueValue);
            TLink trueMarker = links.GetSource(createdTrueLink);
        ...
        public static void AttachNullValueToDocumentTest()
        {
            ...
            TLink createdNullLink = links.GetTarget(createdNullValue);
            TLink nullMarker = links.GetSource(createdNullLink);
        ...
        public static void AttachEmptyArrayValueToDocumentTest()
        {
            ...
            TLink emptyArrayMarker = links.GetTarget(createdArrayLink);
